...
var ne$ = function (current_name, value, params, values) {
  values.push(value)
  params.push(sTypes.escape + RelationalStore.escapeStr(RelationalStore.camelToSnakeCase(current_name)) + sTypes.escape + '<>' + RelationalStore.preparedStatements(values.length))
}
...
var in$ = function (current_name, value, params, values) {
  ...
  for (var index in value) {
    ...
    value[index] = RelationalStore.preparedStatements(values.length)
  }
