  ...
  fields.forEach(function (field) {
    if (jsonSupport) {
      if (_.isArray(ent[field])) {
        // NOTE: Here's the thing. Although the Node.js pg driver does handle
        // automatic parsing and stringification of values for columns of type
        // JSON, it does not, however, does the same for JS arrays. As a result,
        ...
        // https://github.com/brianc/node-postgres/issues/1519#issuecomment-346232804
        //
        //
