...
module.exports = function (opts) {
  ...
  var store = {
    ...
    save: function (args, done) {
      ...
      seneca.act({role: name, hook: 'save'}, args, function (err, result) {
        if (err) {
          return done(err)
        }
    ...
    load: function (args, done) {
      ...
      seneca.act({role: name, hook: 'load'}, args, function (err, result) {
        if (err) {
          return done(err)
        }
    ...
    list: function (args, done) {
      ...
      seneca.act({role: name, hook: 'list'}, args, function (err, result) {
        if (err) {
          return done(err)
        }
    ...
    remove: function (args, done) {
      ...
      seneca.act({role: name, hook: 'remove'}, args, function (err, result) {
        if (err) {
          return done(err)
        }
