...
module.exports = function (opts) {
  ...
  var store = {
    ...
    save: function (args, done) {
      ...
      // TODO: Move the definition inside the internals namespace.
      //
      ...
      // TODO: Move the definition along with other *Ent helpers.
      //
      function upsertEnt(ent, q, sTypes, done) {
        try {
          var upsertFields = cleanArray(q.upsert$)
