...
module.exports = function (opts) {
  ...
  var store = {
    ...
    save: function (args, done) {
      ...
      return buildSaveStm(Object.assign({}, args, { target: name }), function (err, queryObj) {
        if (err) {
  ...
  function buildSaveStm(args, done) {
    var ent = args.ent
    var update = !!ent.id
    var query
    ...
    if (update) {
      query = QueryBuilder.upsertbyidstm(ent, sTypes)
